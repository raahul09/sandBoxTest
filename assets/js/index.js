...
=======
                    <li class="nav-item nav-item-second product-nav-item"><div class="main-nav-two-link"><a class="nav-link nav-second" href="https://www.smeg.com/large-appliances">Major appliances </a></div><div class="navbar-three"><ul role="list">${navbarArr.nav1
                      .map((a) => {
                        return `<li class="nav-item nav-third"><a class="">${a}</a></li>`;
                      })
                      .join("")} </ul></div></li>
                    <li class="nav-item nav-item-second aesthetic-nav-item"><div class="main-nav-two-link"><a class="nav-link nav-second" href="https://www.smeg.com/small-appliances">Small appliances </a></div><div class="navbar-three"><ul role="list">${navbarArr.nav2
                      .map((a) => {
                        return `<li class="nav-item nav-third"><a class="">${a}</a></li>`;
                      })
                      .join("")} </ul></div></li>
                    <li class="nav-item nav-item-second inspiration-nav-item"><div class="main-nav-two-link"><a class="nav-link nav-second" href="https://www.smeg.com/special-project">Special projects </a></div><div class="navbar-three"><ul role="list">${navbarArr.nav3
                      .map((a) => {
                        return `<li class="nav-item nav-third"><a class="">${a}</a></li>`;
                      })
                      .join("")} </ul></div></li>
>>>>>>> 44e1254932b5bd51aca002da3dc564c9bb3a9290
                </ul>
            </div>
        </li>
...
=======
  ...
  if (window.innerWidth <= 767) {
    $(".navbar-nav.nav-second.products-nav > .nav-item.nav-item-second").on(
      "click",
      function (e) {
...
=======
  ...
  function colorChange() {
    setTimeout(function () {
      var color = $(
        ".kettles-slider .swiper-slide.swiper-slide-active img"
      ).attr("data-color");
      var colorVal = $(
        ".kettles-slider .swiper-slide.swiper-slide-active img"
      ).attr("data-color-val");
